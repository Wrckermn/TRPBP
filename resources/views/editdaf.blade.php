...
<body>
	<div class="brand clearfix">
		...
		<ul class="ts-profile-nav">
			<li class="ts-account">
				<a href="#"><img src="{{ asset ('img/ts-avatar.jpg') }}" class="ts-avatar hidden-side" alt=""> Account </a>
			</li>
		</ul>
	</div>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-6">
								<a href="/daftar" style="text-decoration: none">Kembali</a>
								<form method="post" action="/updetdaf">
								{{ csrf_field() }}
								@foreach($users as $d)
								<input type="hidden" name="id" value="{{ $d->id }}">
								Nama : <br>
								<input type="text" name="name" value="{{ $d->name }}" required placeholder='Nama' style="width:400px; height: 30px;"><br><br>
								Email : <br>
								<input type="text" name="email" value="{{ $d->email }}" required placeholder='Email' style="width:400px; height: 30px;"><br><br>
